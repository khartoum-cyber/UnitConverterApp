...
} from "./chunk-7FE3LDFM.js";
import {
  BidiModule,
  Directionality
} from "./chunk-4LC574CR.js";
import {
  NgTemplateOutlet
} from "./chunk-HKX37LQM.js";
import {
...
var SingleBoxSharedResizeObserver = class {
  ...
  _resizeSubject = new import_rxjs10.Subject();
  ...
  observe(target) {
    if (!this._elementObservables.has(target)) {
      this._elementObservables.set(target, new import_rxjs10.Observable((observer) => {
        ...
        (0, import_operators8.filter)((entries) => entries.some((entry) => entry.target === target)),
        // Share a replay of the last event so that subsequent calls to observe the same element
        // receive initial sizing info like the first one. Also enable ref counting so the
        // element will be automatically unobserved when there are no more subscriptions.
        (0, import_operators8.shareReplay)({
          bufferSize: 1,
          refCount: true
        }),
        (0, import_operators8.takeUntil)(this._destroyed)
      ));
    }
...
//# sourceMappingURL=chunk-D2O64GU4.js.map
